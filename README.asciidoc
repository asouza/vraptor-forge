== vraptor4-forge
:idprefix: id_ 
(choose one, do not modify, then add a second sentence with a brief description, starting with - "The vraptor4-forge addon enables blah blah...)
...
----
<dependency>
   <groupId>br.com.caelum.vraptor.forge.addon</groupId>
   <artifactId>vraptor4-forge</artifactId>
